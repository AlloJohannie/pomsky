  ...
  <div class="container-small">
    ...
    <div id="activites" class="text-center md:mb-20 mb-15" data-aos="fade-up" data-aos-delay="180" data-aos-duration="500" data-aos-easing="ease-in-out">
      ...
      <div class="md:space-y-7.5 space-y-5 hs-accordion-group text-start max-w-3xl mx-auto">
        ...
        {{-- #19 Chiot & sport --}}
{{-- #19 Chiot & sport --}}
<div id="chiot-sport" class="hs-accordion bg-body-bg p-5 rounded-2xl">
  <button class="hs-accordion-toggle w-full flex justify-between items-center gap-2.5 text-start">
    <h3 class="md:text-1.5xl text-xl">Est-ce que je peux faire tous les sports avec mon chiot ?</h3>
    <div class="bg-white hs-accordion-active:bg-primary size-7.5 rounded-full flex items-center justify-center">
      <svg class="h-5 w-5 block hs-accordion-active:hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg>
      <svg class="h-5 w-5 hidden hs-accordion-active:block" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/></svg>
    </div>
  ...
  <div class="hs-accordion-content w-full hidden overflow-hidden transition-[height] duration-300">
    <div class="prose prose-sm mt-5">
      <p>
        ...
        Leurs os ne se touchent même pas encore. Ils marchent si joliment avec de grosses pattes souples et des mouvements bancals
        parce que leurs articulations sont entièrement constituées de cartilages, de muscles, de tendons et de ligaments recouverts de peau.
        Rien n'est encore bien ajusté ou n'a encore de véritable prise.
      </p>

      <p>
        Lorsque vous les faites courir de manière excessive ou que vous ne limitez pas leur exercice pour les empêcher d'en faire trop pendant cette période,
        vous ne leur donnez pas la chance de grandir correctement. Chaque grand saut ou course bondissante et excitée provoque des impacts entre les os.
        En quantités raisonnables, ce n'est pas problématique et c'est une usure normale qui s’opèrera.
      </p>

      <p>
        Mais lorsque vous laissez le chiot sauter du canapé ou du lit, l’emmenez faire de longues promenades, vous endommagez cette articulation en formation.
        Lorsque vous laissez le chiot se déplacer sur des carreaux glissants, vous endommagez l'articulation.
      </p>

      <p>
        Vous n'avez la chance de les faire grandir qu'une seule fois. Un corps bien construit est quelque chose qui vient d'un excellent élevage
        et d'une bonne éducation. <strong>LES DEUX</strong>, pas seulement un.
      </p>

      <p>
        Une fois adulte, vous aurez le reste de votre vie à passer à jouer et à vous engager dans des exercices à fort impact.
        Alors gardez-le au calme tant qu’il est encore petit et offrez-lui le cadeau qui ne peut être offert qu'une seule fois.
      </p>
...
<div class="not-prose mt-6">
  <div class="grid md:grid-cols-2 gap-4">
    ...
    <figure class="bg-white rounded-2xl shadow-md overflow-hidden">
      <img
        src="{{ asset('images/element/os_pomsky.jpg') }}"
        alt="Développement des os - chiot"
    ...
    <figure class="bg-white rounded-2xl shadow-md overflow-hidden">
      <img
        src="{{ asset('images/element/tableau.jpg') }}"
        alt="Tableau - sports et âge du chiot"
        class="w-full h-auto object-cover"
        loading="lazy"
      >
    </figure>
    ...
    <figure class="bg-white rounded-2xl shadow-md overflow-hidden md:col-span-2">
      <img
        src="{{ asset('images/element/temps_activite_recommende.jpg') }}"
        alt="Temps d'activité recommandé"
        class="w-full h-auto object-cover"
        loading="lazy"
      >
    </figure>
