...
<section class="py-12 max-w-6xl mx-auto">
  <h2 class="text-2xl font-semibold mb-6">Nos dernières portées</h2>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    @foreach ($litters as $litter)
      <article class="border rounded p-4">
        <h3 class="font-bold">{{ $litter->code }}</h3>
        <p class="text-sm text-gray-600">{{ $litter->status }}</p>
        <a class="text-blue-600 hover:underline" href="{{ route('litters.show', $litter->slug) }}">
          Voir la portée
        </a>
      </article>
    @endforeach
        ...
        <div class="container">
            <div class="grid lg:grid-cols-2 grid-cols-1 lg:gap-37.5 gap-10">
                <div data-aos="fade-right">
                    ...
                    <h1 class="text-white lg:text-6xl md:text-5.5xl text-4xl mb-2.5 box">Intuisssssssssstive solutions for complex challenges</h1>
