...
{{-- 
                ...
                <div class="m-1 hs-dropdown [--trigger:hover] relative inline-flex  transition-all duration-300">
                    ...
                    <div class="hs-dropdown-menu border border-neutral-200 transition-[opacity,margin] rounded-2xl duration hs-dropdown-open:opacity-100 opacity-0 hidden w-[200px] bg-white  mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-hover-event">
                        <div class="p-5">
                            <a href="{{ url('pages.log-in') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Log In
                            </a>

                            <a href="{{ url('pages.sign-up') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Sign Up
                            </a>

                            <a href="{{ url('pages.reset-password') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Reset Password
                            </a>

                            <a href="{{ url('pages.update-password') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Update Password
                            </a>

                            <a href="{{ url('pages.email-confirmation') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Email Confirmation
                            </a>

                            <a href="{{ url('pages.error-404') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Error 404
                            </a>

                            <a href="{{ url('pages.password-protected') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                                Password Protected
                            </a>
                        </div>
                    </div>
        ...
        <div class="hs-accordion-group">
            <div class="hs-accordion">
                ...
                <div class="hs-accordion-content hidden w-full overflow-hidden transition-[height]">
                    <a href="{{ url('public.home') }}" class="flex items-center font-medium text-dark rounded-lg text-base py-1.25 hover:underline">
                        Home 1
                    </a>
