    ...
    <div class="container">
        <div class="grid md:grid-cols-2 md:gap-12.5 lg:grid-cols-8 lg:gap-5 gap-10">
            <div class="lg:col-span-3">
                <a href="{{ url('index') }}">
                    <img src="/images/logo/landinger-light.svg" alt="" class="h-11" />
                </a>
                ...
                <div class="grid grid-cols-2 md:gap-12.5 lg:gap-5 gap-2.5">
                    <div>
                        <ul class="flex flex-col justify-start gap-2.5 leading-normal">
                            <li>
                                <a href="{{ url('index') }}" class="text-primary">Home</a>
                            </li>

                            <li>
                                <a href="{{ url('home.v2') }}" class="hover:text-primary text-white transition-all duration-300">Home 2</a>
                            </li>

                            <li>
                                <a href="{{ url('home.v3') }}" class="hover:text-primary text-white transition-all duration-300">Home 3</a>
                            </li>

                            <li>
                                <a href="{{ url('pages.product-1') }}" class="hover:text-primary text-white transition-all duration-300">Product</a>
                            </li>

                            <li>
                                <a href="{{ url('pages.product-2') }}" class="hover:text-primary text-white transition-all duration-300">Product 2</a>
                            </li>

                            <li>
                                <a href="{{ url('pages.product-3') }}" class="hover:text-primary text-white transition-all duration-300">Product 3</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <ul class="flex flex-col justify-start gap-2.5 leading-normal">
                            <li>
                                <a href="{{ url('pages.about') }}" class="hover:text-primary text-white transition-all duration-300">About</a>
                            </li>

                            <li>
                                <a href="{{ url('pages.request-a-demo') }}" class="hover:text-primary text-white transition-all duration-300">Request a Demo</a>
                            </li>

                            <li>
                                <a href="{{ url('pages.blog') }}" class="hover:text-primary text-white transition-all duration-300">Blog
                                </a>
                            </li>

                            <li>
                                <a href="{{ url('pages.contact') }}" class="hover:text-primary text-white transition-all duration-300">Contact</a>
                            </li>

                            <li>
                                <a href="{{ url('pages.faqs') }}" class="hover:text-primary text-white transition-all duration-300">FAQs
                                </a>
                            </li>

                            <li>
                                <a href="{{ url('pages.privacy-policy') }}" class="hover:text-primary text-white transition-all duration-300">Privacy</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="flex justify-between pt-7.5 md:pt-10">
            <div class="text-sm text-white">
                ...
                <a href="#" class="underline">Landinger.</a>
            </div>
